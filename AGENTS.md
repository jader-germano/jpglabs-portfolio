...
4. Use the generated entry in `internal-docs/implementation-journal.md` as the canonical implementation log for the session.
...
Then the agent must confirm that these internal delivery documents are updated:

- `internal-docs/project-publication-log.md`
- `internal-docs/latest-release-notes.md`
...
- `internal-docs/implementation-journal.md`
- `internal-docs/project-publication-log.md`
- `internal-docs/latest-release-notes.md`
