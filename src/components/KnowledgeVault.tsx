...
export default function KnowledgeVault() {
  ...
  return (
    <section className="py-32 px-8 md:px-20 max-w-7xl mx-auto border-t border-white/5 bg-[#080808]">
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        ...
        <div className="relative w-full md:w-96">
          ...
          <input 
            ...
            className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-sm focus:border-red-500/50 outline-none transition-all font-mono"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {categories.map((cat, i) => (
          ...
          >
            ...
            <div className="mt-8 flex items-center gap-2 text-xs font-black uppercase tracking-widest text-red-500 opacity-0 group-hover:opacity-100 transition-opacity">
      ...
      <div className="mt-12 p-8 rounded-[32px] bg-gradient-to-r from-red-600/10 to-transparent border border-red-500/10 flex flex-col md:flex-row items-center justify-between gap-8">
