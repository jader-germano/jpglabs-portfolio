...
export default function PrivacyPageClient() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white">
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(220,38,38,0.06),transparent_45%)] pointer-events-none" />
      ...
      <main className="relative mx-auto max-w-4xl px-6 py-20">
        ...
        <div className="mt-10 rounded-[36px] border border-white/10 bg-white/[0.03] p-8 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl md:p-12">
          ...
          <div className="mt-8 rounded-3xl border border-red-500/10 bg-red-500/5 p-6 text-sm leading-7 text-gray-300">
            ...
            <p className="mt-3">
              {locale === "pt"
                ? "Solicitações relacionadas a dados, acesso ou revisão devem ser enviadas para contato@jpglabs.com.br."
                : "Requests related to data, access, or review should be sent to contato@jpglabs.com.br."}
            </p>
          </div>
        </div>
      </main>
