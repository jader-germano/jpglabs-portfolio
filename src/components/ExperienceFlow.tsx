...
const baseExperiences = [
  {
    tags: ["Java 17", "Spring 3.22", "Angular 16", "PostgreSQL", "GitLab CI/CD"],
    color: "bg-red-600",
  },
  {
    tags: ["Java 11", "Spring", "Angular 11", "PostgreSQL", "AWS"],
    color: "bg-red-700",
  },
  {
    tags: ["Node.js", "TypeScript", "Angular 8", "Docker", "Kubernetes", "GitLab CI/CD"],
    color: "bg-violet-500",
  },
  {
    tags: ["Node.js", "Express", "Ember.js", "PostgreSQL", "Azure DevOps"],
    color: "bg-gray-600",
  },
] as const;
