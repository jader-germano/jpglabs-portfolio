  ...
  return (
    <section className="mx-auto max-w-7xl px-8 py-32 md:px-20">
      <motion.div
        ...
        className="mb-12"
      >
        <span className="font-mono text-[10px] font-black uppercase tracking-[0.4em] text-red-500">
          ...
          {snippets.map((s, i) => (
            ...
            >
              <div className="mb-1 flex items-center gap-2">
                <Code2 size={12} className={active === i ? "text-red-400" : "text-gray-600"} />
          ...
          >
            <div className="flex items-center justify-between border-b border-white/5 px-6 py-4">
              <div>
                ...
                <p className="mt-0.5 text-[9px] font-black uppercase tracking-widest text-red-500">{snippet.context}</p>
              </div>
