...
export const OWNER_EMAIL_ALIASES = ["jader@jpglabs.com.br", "jader@jpglabs", "jader.germano@icloud.com"] as const;
...
export const normalizeAppRole = (value: unknown): AppRole | null => {
  if (value === "PRIME_OWNER" || value === "ROOT_ADMIN" || value === "master_admin") {
    return "PRIME_OWNER";
  }
