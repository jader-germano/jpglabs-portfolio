...
export const DASHBOARD_ROUTE_INVENTORY: DashboardRouteInventoryItem[] = [
  ...
  },
  {
    ...
    access: "Authenticated",
    description: "AI SDK operator surface for conversational execution, Pi maintenance guidance and internal CRUD assistance.",
    sourceFile: "app/dashboard/assistant/page.tsx",
    sourcePath: "app/dashboard/assistant/page.tsx",
    note: "Consumes the standalone Node backend instead of local Next route handlers.",
  },
  {
    ...
    note: "Legacy compatibility surface while the standalone Node backend becomes the canonical /api owner.",
  },
  {
