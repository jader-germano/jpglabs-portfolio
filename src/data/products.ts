...
export const PRODUCT_CATALOG: ProductCatalogItem[] = [
  ...
  {
    id: '6',
    slug: 'pi-mcp-agentic-service-foundation',
    name: 'PI + MCP Agentic Service Foundation',
    headline: 'Service Personalization Engine',
    summary:
      'Intake estruturado, base de banco, backlog e roadmap para serviços orientados a PI + MCP. Requer LLM agentic com tools e memória operacional.',
    description:
      'Pacote-base para transformar briefing, regras de negócio e restrições de plataforma em uma fundação executável de serviço, com intake obrigatório, proposta de dados, backlog, roadmap e handoff operacional.',
    price: 997,
    tags: ['AGENTIC', 'MCP', 'PI', 'SUPABASE'],
    features: [
      'Mandatory intake schema',
      'Database foundation guidance',
      'Backlog and roadmap pack',
      'Agentic-only operating contract',
    ],
    detailHighlights: [
      'Agrupa contexto, fluxo, dados, integrações e critérios de aceite antes do primeiro build.',
      'Propõe uma fundação de banco e contratos para acelerar a primeira entrega com menos drift.',
      'Mantém blockers e pendências como roadmap ativo em vez de esconder lacunas no prompt.',
      'Exige modelos agentic com tool use e memória; chat-only não sustenta a operação.',
    ],
    accessRoles: ['ADMIN', 'USER_CONSULTANT'],
    pdfUrl: '/downloads/pi-mcp-agentic-service-foundation-ebook.pdf',
  },
];
