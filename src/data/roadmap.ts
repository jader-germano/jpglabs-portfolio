...
export const ROADMAP_ITEMS: RoadmapItem[] = [
  {
    ...
    summary:
      'Replace synthetic dashboard confidence with live operational checkpoints and resolve the current production trust gaps.',
    deliverables: [
    ...
    dependencies: ['Access to VPS logs and Traefik routing state'],
  ...
  },
  {
    ...
    deliverables: [
      'Rename the local folders to jpglabs-portfolio-frontend and jpglabs-portfolio-backend',
  ...
  },
  {
    ...
    summary:
      'Treat the Next application as the first backend/BFF lane and harden it for hundreds or thousands of business users before adding the future Java replica.',
    deliverables: [
  ...
  {
    id: 'deploy-8082',
    title: 'Ship next portfolio build on port 8082',
    area: 'Deployment',
    priority: 'critical',
    status: 'now',
    ownerAgent: 'Agent Launch',
    ...
    summary:
      'Update the local/containerized serving port from 8080 to 8082 and propagate the change through the deployment checklist.',
    deliverables: [
      'Change default compose port mapping to 8082',
      'Rebuild the container and verify the app on the new port',
      'Confirm Traefik/domain routing remains correct after the host-port change',
      'Update operational notes to avoid 8080 assumptions',
    ],
