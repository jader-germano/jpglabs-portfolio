    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16">
          <div className="w-20 h-20 rounded-3xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center text-blue-500 mb-8">
            <study.imageIcon size={40} />
          </div>
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none mb-6">{study.title}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          <div className="md:col-span-2 space-y-12">
            <section>
              <h3 className="text-sm font-black text-blue-500 uppercase tracking-widest mb-4">The Challenge</h3>
              <p className="text-gray-400 leading-relaxed">{study.challenge}</p>
            </section>
            <section>
              <h3 className="text-sm font-black text-blue-500 uppercase tracking-widest mb-4">The Solution</h3>
              <p className="text-gray-400 leading-relaxed">{study.solution}</p>
            </section>
            <section>
              <h3 className="text-sm font-black text-blue-500 uppercase tracking-widest mb-4">Key Results</h3>
