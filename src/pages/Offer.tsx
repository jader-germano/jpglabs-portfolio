      ...
      <main className="pt-20 max-w-5xl mx-auto px-6">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-white/5 rounded-full border border-white/10 p-1 flex gap-2">
            {[
              { id: 'agent', label: 'Agentic Intake', icon: Cpu },
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {activeTab === 'agent' && (
              <div>
                <h2 className="text-3xl font-black text-white mb-4 uppercase italic">Agentic Service Intake</h2>
                <p className="text-gray-500 mb-8 max-w-2xl">
                  Contrato operacional para transformar briefing, fluxo, banco e pendências em uma fundação de serviço. Esta oferta exige modelos agentic com tool use e memória; chat-only não fecha o ciclo.
                </p>
                <div className="bg-black/60 border border-white/5 rounded-2xl p-6 font-mono text-xs leading-relaxed text-blue-400">
                  <pre>{`{
  "business": "service offer and target outcome",
  "workflow": "primary path + approvals + exceptions",
  "data": ["entities", "required fields", "audit rules"],
  "stack": ["frontend", "backend", "database", "deploy target"],
  "constraints": ["security", "lgpd", "public/private boundary"],
  "deliverables": ["db foundation", "contracts", "backlog", "roadmap"],
  "blockers": "explicitly opened when mandatory inputs are missing"
}`}</pre>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                  <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                    <h3 className="text-blue-500 font-black mb-2 uppercase text-sm tracking-widest">Host</h3>
            ...
            {activeTab === 'devops' && (
              <div className="text-center py-10">
                <h2 className="text-3xl font-black text-white mb-12 uppercase italic">VPS Cloud Architecture</h2>
