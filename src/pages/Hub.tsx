...
import { HUB_EXPERIENCES, HUB_TECH_STACK, PROFILE_IDENTITY } from '../data/career-profile';
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-20">
            <section className="px-8 md:px-20 max-w-7xl mx-auto text-left mb-20">
              <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                <span className="text-blue-500 font-mono tracking-[0.3em] text-xs uppercase font-black">{PROFILE_IDENTITY.headline}</span>
                ...
                <p className="text-xl text-gray-400 max-w-xl font-light leading-relaxed pt-8">
                  {PROFILE_IDENTITY.summary} <br />
                  Experiência validada a partir do currículo canônico e do hub operacional.
                </p>
              </motion.div>
            </section>
