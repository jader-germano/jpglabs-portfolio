  ...
  return (
    <>
      ...
      <div className="relative z-10">
        <div className="min-h-screen bg-[#08090a] text-gray-300 font-sans selection:bg-accent/30 selection:text-white overflow-x-hidden">
          ...
          <main className="pt-32 pb-20 max-w-4xl mx-auto px-6">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-accent/20 bg-accent/5 text-accent text-xs font-mono mb-8 uppercase tracking-widest"
            >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-6xl font-bold font-display text-white tracking-tight leading-[1.1] mb-12"
            >
            ...
            <div className="space-y-12 text-left bg-white/5 p-10 rounded-[40px] border border-white/5 backdrop-blur-md">
              <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  <Lock className="text-accent" size={24} /> 1. Proteção de Algoritmos e Agentes
                </h2>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  <Shield className="text-accent" size={24} /> 2. Limitação de Responsabilidade
                </h2>
                <p className="leading-relaxed text-gray-400">
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  <Info className="text-accent" size={24} /> 3. Atualizações e Roadmap
                </h2>
                <p className="leading-relaxed text-gray-400">
            ...
            <div className="mt-12 text-center">
              <a href="/" className="text-accent hover:text-accent/80 font-bold flex items-center justify-center gap-2 transition-colors group">
