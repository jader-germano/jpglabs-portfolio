...
appendEntry(
  isPublish ? 'internal-docs/project-publication-log.md' : 'internal-docs/implementation-journal.md',
  entry,
);
...
console.log(`Documentation entry appended to ${isPublish ? 'internal-docs/project-publication-log.md' : 'internal-docs/implementation-journal.md'}`);
